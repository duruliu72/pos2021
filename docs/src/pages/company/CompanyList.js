...
const CompanyList = () => {
    ...
    const handleDelete=(item) => {
        if(window.confirm("Do you really want to Delete?")) {
            axios.delete("http://localhost:8080/api/companies/"+item.id)
            .then(({data:res}) => {
                 dispatch({
                     type:"DELETE_COMPANY",
                     payload: res,
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-sm-12">
                        <h4 className="pull-left page-title">Company LIST</h4>
                        <ol className="breadcrumb pull-right">
                            <li><Link to="/">Beauty4Me</Link></li>
                            <li><Link to="/companies/new">Create Company</Link></li>
                        </ol>
                    </div>
                </div>
                <div className="row">
