...
import {getWarehouses } from "../../store/warehouseReducer";
...
const CountryList = () => {
    ...
    const handleDelete=(item) => {
        if(window.confirm("Do you really want to Delete?")) {
            axios.delete("http://localhost:8080/api/warehouses/"+item.id)
            .then(({data:res}) => {
                 dispatch({
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-sm-12">
                        <h4 className="pull-left page-title">Warehouse List</h4>
                        <ol className="breadcrumb pull-right">
                            <li><Link to="/">Beauty4Me</Link></li>
                            <li><Link to="/warehouses/new">Create Warehouse</Link></li>
                        </ol>
                    </div>
                </div>
                <div className="row">
